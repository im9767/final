            ...
            <!-- Nested Row within Card Body -->
              <div class="col-lg-6" style="margin: auto">
                <div class="p-5" >
                  ...
                  <form method="post" action="${pageContext.request.contextPath }/business_view/loginok">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="bid" id="bid"  placeholder="아이디 입력">
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" name="bpwd" id="bpwd" placeholder="비밀번호 입력">
                    </div>

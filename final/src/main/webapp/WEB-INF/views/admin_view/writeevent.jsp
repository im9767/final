        ...
        function readURL(input) {
        	for(var a=0;a<input.files.length;a++){
            	...
            	reader.onload = function (e){                               		
            		...
            		var aa=$("<img src='"+e.target.result+"' id='"+input.files[b].name+"'><br>").appendTo("#imgbox");
            		aa.css("width","700px");
            		aa.css("height","700px");
            		console.log(b++);
            		}
				...
				<div class="row" style="height: auto;">
					<div class="col-lg-7" style="margin-left: 10px; margin-top: 20px; margin-bottom: 20px;">
						...
						<div class="user" style="width: 900px; height: 700px;">
							<form method="GET" action="${cp}/admin_view/writeeventok">
								...
								<div id="imgbox" name="imgbox"></div>
								<hr style="width: 900px;">
								<input multiple="multiple" type="file" name="imgIn" id="imgIn" class="btn btn-secondary btn-icon-split" >						

                ...
                <div class="p-5" >
                  ...
                  <form method="post" action="${pageContext.request.contextPath }/loginok">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="aid" id="aid"  placeholder="아이디 입력">
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" name="apwd" id="apwd" placeholder="비밀번호 입력">
                    </div>

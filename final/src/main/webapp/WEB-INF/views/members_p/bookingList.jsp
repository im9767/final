			...
			<table class="table">
			  ...
			  <tbody>
			  	<c:forEach var="bookingList" items="${bookingList }" varStatus="i">
				      ...
				      <th style="vertical-align:middle;" scope="row">${bookingList.START_DATE }</th>
				      <th style="vertical-align:middle;" scope="row">${bookingList.END_DATE }</th>
				      <th style="vertical-align:middle;" scope="row">${bookingList.BOOK_STATUS }</th>
				    </tr>
			  	</c:forEach>
			  </tbody>
			</table>

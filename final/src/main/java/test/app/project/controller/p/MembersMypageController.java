...
public class MembersMypageController {
	...
	public String mypage(HttpSession session, Model model) {
		...
		PageUtil pagination = new PageUtil(1, totalRowCount, 5, 5);
		...
		review.put("mid", mid);
		review.put("startRow", pagination.getStartRow());
		review.put("endRow", pagination.getEndRow());

		List<HashMap<String, Object>> reviewList = membersService.reviewList(review);
	...
	public String infoupdate(String mname, String mid, @RequestParam(value = "mpwd", required = false) String mpwd,
			String memail, String mphone, Model model) {
	...
	public String bookingList(@RequestParam(value = "pageNum", defaultValue = "1") int pageNum, Model model,
			HttpSession session) {
	...
	public String paymentList(@RequestParam(value = "pageNum", defaultValue = "1") int pageNum, Model model,
			HttpSession session) {
	...
	public String reviewInsert(@RequestParam(value = "file1", required = false) List<MultipartFile> multipartFile,
			HttpSession session, String review_title, String review_content,
			@RequestParam(value = "kindness", defaultValue = "1") int kindness,
			@RequestParam(value = "clean", defaultValue = "1") int clean,
			@RequestParam(value = "convenience", defaultValue = "1") int convenience, int room_num) {

		String mid = (String) session.getAttribute("id");

		ReviewVo review = new ReviewVo(0, room_num, mid, review_title, review_content, null, kindness, clean,
				convenience);
